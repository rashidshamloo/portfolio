    ...
    <div className="relative">
      ...
      >
        <div className="aspect-[16/9] w-full transform-style-3d">
          ...
          <h2
            className="will-change-transform pointer-events-none absolute left-[0.5em] top-[5.25em] rounded-[0.75em] bg-black/60 px-[1em] py-[0.5em] font-merriweather leading-[1] text-accent drop-shadow-[0_0_0.5rem_rgba(0,0,0,0.5)] [&>span]:text-[3.75em]"
          ...
          <h3
            className="will-change-transform pointer-events-none absolute left-[1.25em] top-[11.5em] rounded-[0.75em] bg-black/60 px-[1em] py-[0.5em] font-merriweather leading-[1] text-brightBlue drop-shadow-[0_0_0.5rem_rgba(0,0,0,0.5)] [&>span]:text-[2.5em]"
          ...
          <p
            className="will-change-transform absolute left-[2em] right-[7.5em] top-[85%] hidden rounded-[0.75em] bg-black/60 p-[0.5em] text-[max(1em,14px)] leading-[1.5] text-brightBlue drop-shadow-[0_0_0.5rem_rgba(0,0,0,0.5)] sm:right-[8.5em] md:bottom-[3em] md:left-[4em] md:right-[4em] md:top-auto md:block lg:max-w-[50%] lg:p-[1em]"
